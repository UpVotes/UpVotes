...
namespace UpVotes.Controllers
{
    public class BlogsController : Controller
    {
        ...
        public ActionResult article(string id)
        {
            ...
            string[] articleArray = { "how-much-cost-make-app", "app-store-optimization", "email-marketing-for-financial-advisors", "mobile-app-development-trends", "digital-marketing-trends-2020", "on-demand-app-services" };
